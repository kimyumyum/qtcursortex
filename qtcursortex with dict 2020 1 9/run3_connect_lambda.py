...
class MainPage(QMainWindow):
    ...
    def __init__(self):
        ...
        #mm = self.getBgbStringList('trunk')
        #dm.syn('happy')
        #self.addToTable(mm)
        #print(mm)
        ...
        self.jjaLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('jja'))
        self.jjbLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('jjb'))
        self.synLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('syn'))
        self.trgLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('trg'))
        self.antLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('ant'))        
        self.spcLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('spc'))
        self.genLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('gen'))
        self.comLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('com'))
        self.parLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('par'))
        self.bgaLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('bga'))
        self.bgbLineEdit.cursorPositionChanged.connect(lambda: self.addToTable('bgb'))
        ...
        print (type(mm[1]))+-
        '''
        '''mm = dm.ws('satisfy',100)
        print(len(mm))
        #print(mm)
        self.addItems(mm)
        self.addToTable(mm)
        stringList = self.convertToStringList(mm)
        words = self.showWords(stringList)
        print (words)
        '''
