...
class MainPage(QMainWindow):
    ...
    def toSimpleForm(self):
        temp = self.answerLine.text()
        convertedNoun = toSimpleNoun(temp)
        self.nounSimpleLineEdit.setText(convertedNoun)
        convertedVerb = toSimpleVerb(temp)
    ...
    def addToDB(self, word):
        ...
        print('prepared insert - '+str(self.q.exec()))
    ...
    def setjjaText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('jja db works?: ' + str(self.q.exec()))
            self.q.next()
    ...
    def setjjbText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('jjb db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setsynText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('syn db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def settrgText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('trg db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setantText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('ant db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setspcText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('spc db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setgenText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('gen db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setcomText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('com db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setparText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('par db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setbgaText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('bga db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
    ...
    def setbgbText(self, word=''):
        ...
        if not word:
            ...
            self.q.bindValue(":word",word)
            print('bgb db works?: ' + str(self.q.exec()))
            self.q.next()
            stringList= self.q.value(0).split(',')
        else:
